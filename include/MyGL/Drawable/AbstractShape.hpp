...
namespace my
{
    ...
    public:
         ...
         */
        MYGL_EXPORT virtual void setPosition(int x, int y, bool center = false);
         ...
         */
        MYGL_EXPORT virtual void setPosition(const glm::vec2& pos, bool center = false);
         ...
         *               bottom left hand corner at (x,y). Default value is false
         */
        MYGL_EXPORT virtual void setRelativePosition(int x, int y, const my::Camera& camera, bool center = false);
         ...
         *               bottom left hand corner at (x,y). Default value is false
         */
        MYGL_EXPORT virtual void setRelativePosition(const glm::vec2& pos, const my::Camera& camera, bool center = false);
         ...
         */
        MYGL_EXPORT virtual void move(float x, float y) noexcept;
         ...
         */
        MYGL_EXPORT virtual void setColor(const my::Color& color) noexcept;
         ...
         */
        MYGL_EXPORT virtual void setTexture(const my::Texture& texture);
         ...
         */
        MYGL_EXPORT virtual void draw(const glm::mat4& lookAt, const glm::mat4& projection) const = 0;
    };
